...
public class RedHomeRunnerV1 implements IAutonomousRunner {
    ...
    public RedHomeRunnerV1(SampleMecanumDrive inDrive, ArmWrapper inArm, LinearOpMode inLinearOpMode, AutonomousWrapper inWrapper) {
        drive = inDrive;
        armWrapper = inArm;
