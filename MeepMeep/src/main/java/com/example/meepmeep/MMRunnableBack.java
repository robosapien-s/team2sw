...
public class MMRunnableBack implements IMeepMeepRunnable {
    @Override
    public void run() {
        MeepMeep meepMeep = new MeepMeep(800);

        final int IndexStart = 0;
        final int IndexDrop1 = 1;
        final int IndexOutsideWH = 2;
        final int IndexInsideWH = 3;
        final int IndexOutsideWH2 = 4;
        final int IndexDrop2 = 5;
